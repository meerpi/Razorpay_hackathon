              ...
              <button
                ...
                className={clsx(
                  ...
                  opt.isAmber && needsReviewCount > 0 && !isActive
                    ? 'bg-human-amber/15 text-human-amber border border-human-amber/40 shadow-[0_0_10px_var(--human-amber-glow)] hover:bg-human-amber/25'
                    : '',
                  isActive && opt.isAmber
                    ? 'bg-human-amber text-canvas border border-human-amber font-semibold shadow-[0_0_14px_var(--human-amber-glow)]'
                    : '',
                  isActive && !opt.isAmber
                    ? 'bg-brand-blue text-white border border-brand-blue font-semibold shadow-blue-glow'
                    : '',
                  !isActive && !opt.isAmber
                    ? 'glass-panel text-text-secondary hover:text-text-primary hover:bg-glass-bg'
                    : ''
                )}
              >
        ...
        <div className="flex items-center gap-2">
          ...
          <div className="flex items-center gap-1">
            ...
            <select
              ...
              className="bg-canvas-raised border border-glass-border rounded-md px-2.5 py-1.5 text-xs text-text-primary focus:outline-none focus:border-brand-blue font-mono"
            >
          ...
          <div className="relative">
            ...
            <input
              ...
              className="pl-8 pr-3 py-1.5 bg-canvas-raised border border-glass-border rounded-md text-xs text-text-primary placeholder:text-text-tertiary focus:outline-none focus:border-brand-blue w-48 sm:w-60 font-mono"
            />
          </div>
        </div>
      </div>
